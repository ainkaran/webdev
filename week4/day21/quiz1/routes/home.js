...
// URL: http://localhost:4545/dashboard HTTP VERB: GET
// router.get('/dashboard', function (request, response) {
//   response.render('tweets', {vTweet: undefined, vUsername: undefined});
// });
...
//   // survey_info = { username: 'qq', message: 'q' }
//
//   const m = survey_info.message;
//   const userName = survey_info.username;
//
//   console.log('test');
//   response.render('tweets', {vTweet: m, vUsername: userName});
//
// });
...
//   `, tweet
//   ).then(() => {
//     db.query(`SELECT content FROM tweets ORDER BY id DESC`)
//       .then( response => {
